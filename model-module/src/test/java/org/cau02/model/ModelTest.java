...
class ModelTestObserver implements YutNoriObserver {
    ...
    public void onGameEnded() {
        logBuilder.append("<game ended> (Winner: Player ")
                .append(gm.getWinner())
                .append(")\n");
        flush();
    }
    ...
    void flush() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("model-module/target/test-logs/model_test_log.txt", true))) {
